...
function Neo4jD3(_selector, _options) {
    ...
    function appendNode() {
        return node
            ...
            .on('contextmenu', function (d) {
                ...
                if (typeof options.onNodeRightClick === 'function') {           //添加右键点击函数
    ...
    function appendRelationship() {
        return relationship
            ...
            .on('contextmenu', function (d) {           //relationship的右键点击
                d3.event.preventDefault();
                if (typeof options.onRelationshipRightClick === 'function') {
                    options.onRelationshipRightClick(d);
                }
            })
            .on('click', function (d) {
