  ...
  return (
    <div className="pdf-preview">
      <div className="left">
        ...
        <PdfRender url={PRIMARY_PDF_URL} onPhScroll={onPhScrollLeft} highlights={highlights.source} />

        {/* <PdfRender url={"./utils/pdf/sample1.pdf"} onPhScroll={onPhScrollLeft} highlights={highlights.source} /> */}
      ...
      <div className="right" ref={rightDom}>
        ...
        <PdfRender url={SECONDARY_PDF_URL} highlights={highlights.target} />
      </div>
